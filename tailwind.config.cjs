...
module.exports = {content:['./index.html','./src/**/*.js'],theme:{extend:{colors:{indigo:green,blue:green,purple:green,green,orange:copper,yellow:copper,pink:wine,red:wine}}},plugins:[]};
